...
| 파일 | 설명 |
|------|------|
| `ClaudeTokenTracker-vX.X.X.dmg` | DMG 설치 파일 (Applications로 드래그) |
| `ClaudeTokenTracker-vX.X.X.zip` | 앱 번들 ZIP |

---

## 스크린샷

| Claude Token Tracker | Claude Desktop 설정 |
|:---:|:---:|
...
2. `ClaudeTokenTracker-vX.X.X.dmg` 다운로드
3. DMG를 열고 **Claude Token Tracker**를 Applications로 드래그
...
├── ClaudeTokenTracker.swift       - @main 앱 진입점
├── Models/
